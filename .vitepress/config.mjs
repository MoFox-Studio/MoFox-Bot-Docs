  ...
  },
  {
    ...
    items: [
      ...
      { text: '进阶开发', link: '/docs/development/plugin_develop/advanced' },
      {
        ...
        collapsed: false,
        items: [
          { text: '1. 写在前面', link: '/docs/development/plugin_develop/guide/plugin-authoring/1-introduction' },
          { text: '2. 最小概念', link: '/docs/development/plugin_develop/guide/plugin-authoring/2-minimal-concept' },
          { text: '3. 第一个插件', link: '/docs/development/plugin_develop/guide/plugin-authoring/3-first-plugin' },
          { text: '4. 运行机制', link: '/docs/development/plugin_develop/guide/plugin-authoring/4-how-it-works' },
          { text: '5. 插件结构', link: '/docs/development/plugin_develop/guide/plugin-authoring/5-structure' },
          { text: '6. 配置系统', link: '/docs/development/plugin_develop/guide/plugin-authoring/6-config' },
          { text: '7. Command 与 Service', link: '/docs/development/plugin_develop/guide/plugin-authoring/7-command-and-service' },
          { text: '8. 第一个 Tool', link: '/docs/development/plugin_develop/guide/plugin-authoring/8-first-tool' },
          { text: '9. Prompt API', link: '/docs/development/plugin_develop/guide/plugin-authoring/9-prompt-api' },
          { text: '10. LLM API', link: '/docs/development/plugin_develop/guide/plugin-authoring/10-llm-api' },
          { text: '11. Tool 与 LLM', link: '/docs/development/plugin_develop/guide/plugin-authoring/11-tool-llm' },
          { text: '12. Default Chatter 与 FSM', link: '/docs/development/plugin_develop/guide/plugin-authoring/12-default-chatter-fsm' },
          { text: '13. Agent 编排', link: '/docs/development/plugin_develop/guide/plugin-authoring/13-agent-orchestration' },
          { text: '14. Action 组件', link: '/docs/development/plugin_develop/guide/plugin-authoring/14-action' },
          { text: '15. 事件系统', link: '/docs/development/plugin_develop/guide/plugin-authoring/15-event-system' },
          { text: '16. Chatter 组件', link: '/docs/development/plugin_develop/guide/plugin-authoring/16-chatter' },
          { text: '17. Router 组件', link: '/docs/development/plugin_develop/guide/plugin-authoring/17-router' },
          { text: '18. Adapter 组件', link: '/docs/development/plugin_develop/guide/plugin-authoring/18-adapter' },
          { text: '19. 消息模型', link: '/docs/development/plugin_develop/guide/plugin-authoring/19-message-model' },
          { text: '20. 总览与下一步', link: '/docs/development/plugin_develop/guide/plugin-authoring/20-overview-and-next' },
        ]
      },
      {
        text: '插件组件',
