...
:::warning 重要提示：请切换到 Dev 分支
要使用本指南中介绍的 WebUI 可视化配置功能，您**必须**将MoFox-Bot切换到 `dev` 分支，并确保MoFox-Bot和MoFox-Core-Webui已更新到最新版本。

**如何操作：**
详见[维护指南](../../guides/maintenance_guide.md)中的“切换分支”部分。

稳定版用户请注意：此功能将在未来的正式版本中提供，敬请期待。
:::
