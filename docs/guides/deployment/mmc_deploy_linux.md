# <iconify-icon icon="mdi:linux" height="30"></iconify-icon> Neo-MoFox Linux 部署指南 

## 概述

欢迎使用 Neo-MoFox，一个高度可定制化的 AI Bot 框架。

本指南将引导您在 Linux 环境下，使用项目**OneBot 适配器插件**完成 Neo-MoFox 的全部署流程。该方式是官方推荐的最佳实践，具有以下优势：

*   **部署简化**：仅需下载和运行 Neo-MoFox / SnowLuma 项目。
*   **操作便捷**：只需管理 Neo-MoFox / SnowLuma 进程。
