...
你好！感谢你选择 MoFox-Core。在开始之前，请花几分钟时间阅读这份协议。我们用问答的形式，帮助你快速了解使用这个**第三方修改版**软件时，你的权利和责任。
...
*   **第三方修改版**：首先，你需要清楚地知道，MoFox-Core 是一个基于[MaiCore](https://mai-mai.org/)开源项目的**第三方修改版**。我们（MoFox-Core 团队）与原始项目的开发者**没有任何关联**。
*   **独立维护**：我们独立负责这个修改版的维护、开发和更新。因此，原始项目的开发者**不会**为 MoFox-Core 提供任何技术支持，也**不会**对因使用本修改版产生的任何问题负责。
...
MoFox-Core 通过插件系统实现功能扩展，但这需要你承担相应的责任。

*   **谁开发的插件？**：绝大多数插件是由**社区里的第三方开发者**创建和维护的，他们并**不是 MoFox-Core 核心团队的成员**。
...
*   **AI 回复的立场**：机器人的所有回复均由第三方大语言模型生成，其观点和信息**不代表 MoFox-Core 团队的立场**。我们不对其准确性、完整性或可靠性负责。
*   **无责任声明**：在任何情况下，MoFox-Core 团队均不对因使用或无法使用本项目（特别是第三方插件）而导致的任何直接、间接、偶然、特殊或后果性的损害（包括但不限于数据丢失、利润损失、业务中断）承担责任。
...
*   **最终解释权**：在法律允许的范围内，MoFox-Core 团队保留对本协议的最终解释权。
