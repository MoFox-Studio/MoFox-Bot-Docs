...
3.  **你的环境信息是什么？**
    ...
    -   **相关软件版本**：例如 `Python 3.10.4`, `Neo-MoFox v1.2.0`。
...
> **标题**：Neo-MoFox 在 Windows Server 2022 上启动时报错 `ModuleNotFoundError`
>
> **正文**：
> 大家好，
>
> 我正在尝试在我的 Windows Server 2022 服务器上部署 Neo-MoFox，但是在执行 `start.bat` 后程序报错退出了。
>
> **我的目标**：成功启动 Neo-MoFox 并让它保持在线。
>
